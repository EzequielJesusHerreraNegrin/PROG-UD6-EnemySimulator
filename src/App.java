                        ...
                        switch (inputEnemy) {
                            case "1":
                                ...
                                while (character.getHealth() > 0 && enderman.getHealth() > 0) {
                                    ...
                                    if (turn == 0) {
                                        enderman.getDamage(character.attact());
                                        turn = 1;
                                    } else {
                                        if (action % 2 == 0) {
                                            character.getDamage(enderman.attact());
                                        } else {
                                            enderman.move();
                                        }
                                        turn = 0;
                            ...
                            case "2":
                                ...
                                while (character.getHealth() > 0 && zombi.getHealth() > 0) {
                                    int action = (int) Math.round(Math.random() * 10);
                                    if (turn == 0) {
                                        zombi.getDamage(character.attact());
                                        turn = 1;
                                    } else {
                                        if (action % 2 == 0) {
                                            character.getDamage(zombi.attact());
                                        } else {
                                            zombi.move();
                                        }
                                        turn = 0;
                            ...
                            case "3":
                                ...
                                while (character.getHealth() > 0 && sheep.getHealth() > 0) {
                                    if (turn == 0) {
                                        sheep.getDamage(character.attact());
                                        turn = 1;
                                    } else {
                                        int action = (int) Math.round(Math.random() * 10);
                                        if (action % 2 == 0) {
